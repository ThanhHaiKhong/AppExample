...
@available(iOS 15.0, *)
public class AsyncDownloader: NSObject {
    let url: URL
    let destination: URL
...
@available(iOS 15.0, *)
public final class AsyncDownloaderSession: NSObject, URLSessionDownloadDelegate {
    ...
    public func download(url: URL, destination: URL) -> AsyncDownloader {
