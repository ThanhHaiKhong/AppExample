...
public struct TypesEntry: Sendable {
  ...
  public var field: TypesField {
    get {return _field ?? TypesField()}
    set {_field = newValue}
  }
  ...
  fileprivate var _field: TypesField? = nil
  fileprivate var _validator: String? = nil
}
...
extension TypesEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularMessageField(value: &self._field) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self._validator) }()
      default: break
      }
    }
  }
